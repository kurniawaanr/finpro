...
function checkout() {
    ...
    useEffect(() => {
        setShippingName("William Onnyx");
        setShippingPhone("081992837489");
        setShippingAddress("22, Street Road, South Jakarta, DKI Jakarta, 12009");
                                    ...
                                    {products.map((item) => {
                                        return (
                                            <Fragment>
                                                ...
                                                <Col className="gutter-row" span={8}>Rp {formatNumberCurrency(item.itemSubtotal)}</Col>
                                            </Fragment>
                                        );
                                    })}
                                </Fragment>
